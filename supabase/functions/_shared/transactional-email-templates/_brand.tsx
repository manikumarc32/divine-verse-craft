...
// Inline lotus SVG as data URI — works in every email client.
const LOTUS_SVG =
...
export const BrandFooter: React.FC<{ replyTo?: string }> = ({ replyTo }) => (
  <Section style={footerSection}>
    {replyTo && (
      <Text style={replyText}>
        Reply directly or write to{' '}
        <a href={`mailto:${replyTo}`} style={{ color: brand.saffron, textDecoration: 'none', fontWeight: 'bold' }}>
          {replyTo}
        </a>
      </Text>
    )}
